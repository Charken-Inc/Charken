...
public class ModelWarlm_normal<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "warlm_normal"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition heaad = partdefinition.addOrReplaceChild("heaad",
				CubeListBuilder.create().texOffs(16, 22)
						.addBox(-1.0F, -1.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 14)
						.addBox(-2.0F, -2.0F, -3.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-1.0F, -3.0F, -2.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
