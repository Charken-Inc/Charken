...
@Mod("charken")
public class CharkenMod {
	public static final Logger LOGGER = LogManager.getLogger(CharkenMod.class);
	public static final String MODID = "charken";

	public CharkenMod(IEventBus modEventBus) {
