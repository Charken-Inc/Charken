...
public class GoatinEntity extends Monster {
	public GoatinEntity(EntityType<GoatinEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(12, new AvoidEntityGoal<>(this, Goat.class, (float) 6, 1, 1.2));
	...
	protected void dropCustomDeathLoot(ServerLevel serverLevel, DamageSource source, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(serverLevel, new ItemStack(Items.GOAT_HORN));
	}
	...
	public SoundEvent getDeathSound() {
		return BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("entity.goat.screaming.hurt"));
	}
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(CharkenModEntities.GOATIN.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
