...
public class TurtkenTamedEntity extends TamableAnimal {
	public TurtkenTamedEntity(EntityType<TurtkenTamedEntity> type, Level world) {
		super(type, world);
		xpReward = 20;
		setNoAi(false);
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		TurtkenTamedEntity retval = CharkenModEntities.TURTKEN_TAMED.get().create(serverWorld, EntitySpawnReason.BREEDING);
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(CharkenModBlocks.COMPRESSED_SEAGRASS_BLOCK.get().asItem()).test(stack);
	}
