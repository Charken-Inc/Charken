...
public class EGGFruitDecorator extends CocoaDecorator {
	public static MapCodec<EGGFruitDecorator> CODEC = MapCodec.unit(EGGFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("charken:egg_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public EGGFruitDecorator() {
		super(0.2f);
	}
