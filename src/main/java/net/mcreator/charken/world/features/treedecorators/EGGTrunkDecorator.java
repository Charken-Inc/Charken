...
public class EGGTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<EGGTrunkDecorator> CODEC = MapCodec.unit(EGGTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("charken:egg_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
