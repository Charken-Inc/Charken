...
public class EGGLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<EGGLeaveDecorator> CODEC = MapCodec.unit(EGGLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("charken:egg_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public EGGLeaveDecorator() {
		super(0.25f);
	}
