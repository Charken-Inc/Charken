...
public class CharkenModBiomes {
			...
			if (dimensionType.is(BuiltinDimensionTypes.OVERWORLD)) {
				...
				if (chunkGenerator.getBiomeSource() instanceof MultiNoiseBiomeSource noiseSource) {
					...
					addParameterPoint(parameters, new Pair<>(new Climate.ParameterPoint(Climate.Parameter.span(-0.6f, 0.5f), Climate.Parameter.span(-0.5f, 0.5f), Climate.Parameter.span(0.3f, 1f), Climate.Parameter.span(-0.5f, 0.5f),
							Climate.Parameter.span(0.2f, 0.9f), Climate.Parameter.span(-1f, 0.9f), 0), biomeRegistry.getOrThrow(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("charken", "egg_caves")))));
					chunkGenerator.biomeSource = MultiNoiseBiomeSource.createFromList(new Climate.ParameterList<>(parameters));
					chunkGenerator.featuresPerStep = Suppliers
							.memoize(() -> FeatureSorter.buildFeaturesPerStep(List.copyOf(chunkGenerator.biomeSource.possibleBiomes()), biome -> chunkGenerator.generationSettingsGetter.apply(biome).features(), true));
				}
				if (chunkGenerator instanceof NoiseBasedChunkGenerator noiseGenerator) {
					((CharkenModNoiseGeneratorSettings) (Object) noiseGenerator.settings.value()).setcharkenDimensionTypeReference(dimensionType);
				}
			}
		}
	}
	...
	private static SurfaceRules.RuleSource injectOverworldSurfaceRules(SurfaceRules.RuleSource currentRuleSource) {
		...
		customSurfaceRules.add(anySurfaceRule(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("charken", "egg")), CharkenModBlocks.EGGGRASS.get().defaultBlockState(), CharkenModBlocks.EGGDIRT.get().defaultBlockState(),
				CharkenModBlocks.EGGSTONE.get().defaultBlockState()));
		customSurfaceRules.add(anySurfaceRule(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("charken", "egg_caves")), CharkenModBlocks.EGGSTONE.get().defaultBlockState(),
				CharkenModBlocks.EGGSTONE.get().defaultBlockState(), CharkenModBlocks.EGGSTONE.get().defaultBlockState()));
		customSurfaceRules.add(preliminarySurfaceRule(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("charken", "egg")), CharkenModBlocks.EGGGRASS.get().defaultBlockState(),
				CharkenModBlocks.EGGDIRT.get().defaultBlockState(), CharkenModBlocks.EGGSTONE.get().defaultBlockState()));
		customSurfaceRules.add(preliminarySurfaceRule(ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath("charken", "egg_forest")), CharkenModBlocks.EGGGRASS.get().defaultBlockState(),
				CharkenModBlocks.EGGDIRT.get().defaultBlockState(), CharkenModBlocks.EGGSTONE.get().defaultBlockState()));
	...
	public interface CharkenModNoiseGeneratorSettings {
		void setcharkenDimensionTypeReference(Holder<DimensionType> dimensionType);
	}
}