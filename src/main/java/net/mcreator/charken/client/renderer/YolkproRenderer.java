...
public class YolkproRenderer extends EntityRenderer<YolkproEntity, LivingEntityRenderState> {
	private static final ResourceLocation texture = ResourceLocation.parse("charken:textures/entities/yolk.png");
	private final Modelyolkpro model;

	public YolkproRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new Modelyolkpro(context.bakeLayer(Modelyolkpro.LAYER_LOCATION));
	}
	...
	@Override
	public void extractRenderState(YolkproEntity entity, LivingEntityRenderState state, float partialTicks) {
