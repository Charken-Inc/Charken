...
public class ModelCustomModel<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("charken", "model_custom_model"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition heaad = partdefinition.addOrReplaceChild("heaad",
				CubeListBuilder.create().texOffs(16, 22).addBox(-1.0F, -1.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 23).addBox(-1.0F, -4.0F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(8, 23)
						.addBox(-1.0F, -5.0F, -1.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(14, 23).addBox(0.0F, -5.0F, 0.0F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 14)
