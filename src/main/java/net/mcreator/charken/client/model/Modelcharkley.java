...
public class Modelcharkley extends EntityModel<LivingEntityRenderState> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("charken", "modelcharkley"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(40, 78).addBox(1.0F, 4.0F, 13.0F, 3.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(42, 87)
				.addBox(7.0F, 5.0F, 0.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(20, 20).addBox(-4.0F, 5.0F, 0.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, -1.0F, -1.0F));
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 43).addBox(-5.0F, 5.3911F, 5.0887F, 13.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)).texOffs(0, 22).addBox(-2.0F, 11.3911F, 2.0887F, 7.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
